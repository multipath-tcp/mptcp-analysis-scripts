...
parser.add_argument("-s",
                    "--stat", help="directory where the stat files are stored", default=co.DEF_STAT_DIR+'_lo')
parser.add_argument("-A",
                    "--aggl", help="directory where data of agglomerated graphs are stored", default=co.DEF_AGGL_DIR+'_lo')
parser.add_argument('-S',
                    "--sums", help="directory where the summary graphs will be stored", default=co.DEF_SUMS_DIR+'_lo')
parser.add_argument("-a",
